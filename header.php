<header style="text-align: center; background-color: white; padding: 20px; margin-bottom: 30px; box-shadow: 0 2px 5px rgba(0,0,0,0.1);">
    <a href="conference.php">
        <img src="images/ConferenceLogo.png" alt="Forum Logo" style="width: 250px; height: auto;">
    </a>
